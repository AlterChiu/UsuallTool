...
public class AtDateClass {
	...
	public AtDateClass(String dateString, String inputFormat) throws ParseException {
		this.dateLong = TimeTranslate.getDateLong(dateString, inputFormat);
		process();
	}
	...
	private void setYear() {
		this.year = Integer.parseInt(TimeTranslate.getDateString(dateLong, "yyyy"));
	}

	private void setMonth() {
		this.month = Integer.parseInt(TimeTranslate.getDateString(dateLong, "MM"));
	}

	private void setDay() {
		this.day = Integer.parseInt(TimeTranslate.getDateString(dateLong, "dd"));
	}

	private void setHour() {
		this.hour = Integer.parseInt(TimeTranslate.getDateString(dateLong, "HH"));
	}

	private void setMinite() {
		this.minute = Integer.parseInt(TimeTranslate.getDateString(dateLong, "mm"));
	}

	private void setSecond() {
		this.second = Integer.parseInt(TimeTranslate.getDateString(dateLong, "ss"));
	}
	...
	private void translate() throws ParseException {
		this.year = Integer.parseInt(TimeTranslate.getDateString(this.dateLong, "yyyy"));
		this.month = Integer.parseInt(TimeTranslate.getDateString(this.dateLong, "HH"));
		this.day = Integer.parseInt(TimeTranslate.getDateString(this.dateLong, "dd"));
		this.hour = Integer.parseInt(TimeTranslate.getDateString(this.dateLong, "HH"));
		this.minute = Integer.parseInt(TimeTranslate.getDateString(this.dateLong, "mm"));
		this.second = Integer.parseInt(TimeTranslate.getDateString(this.dateLong, "ss"));
	}

	public String getDateString(String outputFormat) {
		return TimeTranslate.getDateString(this.dateLong, outputFormat);
	}
