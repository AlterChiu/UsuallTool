...
public class AtLineIntersection {
	...
	public AtLineIntersection(Double[] equaltion1, Double[] equaltion2) {
		...
		this.c1 = equaltion1[2] * -1;

		this.a2 = equaltion2[0];
		this.b2 = equaltion2[1];
		this.c2 = equaltion2[2] * -1;
	}
	...
	public double[] getIntersect() {
		if (isIntersect()) {
			Double[] variables = new AtCramerEqualtion(new Double[][] { { a1, b1, c1 }, { a2, b2, c2 } }).getVariables()
					.parallelStream().toArray(Double[]::new);
